 ...
 * Plans CRUD
 */
Route::middleware('auth:web')->prefix('plans')->namespace('Admin')->group(function () {
    Route::get('/', [\App\Http\Controllers\Web\Admin\PlansController::class, 'index'])->name('plans.index');
    Route::get('/create', [\App\Http\Controllers\Web\Admin\PlansController::class, 'create'])->name('plans.create');
    Route::post('/', [\App\Http\Controllers\Web\Admin\PlansController::class, 'store'])->name('plans.store');
    Route::get('edit/{plan}', [\App\Http\Controllers\Web\Admin\PlansController::class, 'edit'])->name('plans.edit');
